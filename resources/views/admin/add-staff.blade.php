                            ...
                            <form action="{{url('/addStaff')}}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row register-form">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <div class="maxl">
                                                ...
                                                <label class="radio inline">
                                                    <input type="radio" required name="maritalStatus" value="Divorced">
                                                    <span>Divorced </span>
                                                </label>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <input type="text" class="form-control" placeholder="User Id *" required name="userid" />
                                        </div>
                                        <div class="form-group">
                                            <input type="password" class="form-control" id="password" placeholder="Password *" required name="password" />
                                            <input type="checkbox" name="" onclick="viewPasswordToggle()" style="cursor: pointer;"> Show Password
                                        </div>
                                        <input type="submit" class="btnRegister btn btn-primary" name="addStaff" />
